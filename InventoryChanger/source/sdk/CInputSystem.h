...
public:
    ...
    virtual void AttachToWindow(void*) = 0;
    virtual void DetachFromWindow(void*) = 0;
    ...
    virtual int GetAnalogValue(void* code) = 0;
    virtual int GetAnalogDelta(void* code) = 0;
    ...
    virtual const char* CodeToStringAnalog(void* code) = 0;
    virtual ButtonCode_t StringToButtonCode(const char*) = 0;
    virtual void* StringToAnalogCode(const char*) = 0;
    ...
    virtual void SetCursorPosition(int x, int y, void* window) = 0;
    virtual void IsWindowAttached(void*) = 0;
    virtual void GetStandardCursor(void) = 0;
    virtual void SetStandardCursor(void*, void*) = 0; // 50
    ...
    virtual void StartDraggingWindow(void*) = 0;
    virtual void SetCursorClip(void*) = 0;
	...
	//bool IsKeyDown(int cKey);
 //   int  VirtualKeyToButtonCode(int cVirtualKey);
};
